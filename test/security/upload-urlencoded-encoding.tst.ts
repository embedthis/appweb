...
check(reply.decoded, 'PVAR user=guest&role=admin')
check(reply.decoded, 'PVAR a=1&admin=x')
check(reply.decoded, 'PVAR round=100%+ ok')
reject(reply.decoded, 'PVAR role=admin')
reject(reply.decoded, 'PVAR admin=x')
