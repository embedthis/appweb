...
NAME                  := appweb
VERSION               := 9.1.0
PROJECT               := appweb-vxworks-default
PROFILE               ?= dev
...
ME_CONFIGURE          ?= \"me -d -q -platform vxworks-arm-default -configure . --with esp --with mdb --with cgi --with fast --with proxy -gen make\"
ME_CONFIGURED         ?= 1
ME_DEBUG              ?= 1
...
DFLAGS                += -DCPU=ARMARCH7 -DRW_MULTI_THREAD -DTOOL=gnu -DTOOL_FAMILY=gnu -DVXWORKS -D_GNU_TOOL -D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h" -D_WRS_KERNEL_ $(patsubst %,-D%,$(filter ME_%,$(MAKEFLAGS))) "-DME_COM_CGI=$(ME_COM_CGI)" "-DME_COM_COMPILER=$(ME_COM_COMPILER)" "-DME_COM_DIR=$(ME_COM_DIR)" "-DME_COM_EJS=$(ME_COM_EJS)" "-DME_COM_ESP=$(ME_COM_ESP)" "-DME_COM_FAST=$(ME_COM_FAST)" "-DME_COM_HTTP=$(ME_COM_HTTP)" "-DME_COM_LIB=$(ME_COM_LIB)" "-DME_COM_LINK=$(ME_COM_LINK)" "-DME_COM_MBEDTLS=$(ME_COM_MBEDTLS)" "-DME_COM_MDB=$(ME_COM_MDB)" "-DME_COM_MPR=$(ME_COM_MPR)" "-DME_COM_OPENSSL=$(ME_COM_OPENSSL)" "-DME_COM_OSDEP=$(ME_COM_OSDEP)" "-DME_COM_PCRE=$(ME_COM_PCRE)" "-DME_COM_PHP=$(ME_COM_PHP)" "-DME_COM_PROXY=$(ME_COM_PROXY)" "-DME_COM_SQLITE=$(ME_COM_SQLITE)" "-DME_COM_SSL=$(ME_COM_SSL)" "-DME_COM_VXWORKS=$(ME_COM_VXWORKS)" "-DME_COM_WATCHDOG=$(ME_COM_WATCHDOG)" "-DME_CERTS_GENDH=$(ME_CERTS_GENDH)" "-DME_ESP_CMD=$(ME_ESP_CMD)" "-DME_ESP_LEGACY=$(ME_ESP_LEGACY)" "-DME_ESP_MODULE=$(ME_ESP_MODULE)" "-DME_ESP_NAME=$(ME_ESP_NAME)" "-DME_HTTP_BASIC=$(ME_HTTP_BASIC)" "-DME_HTTP_CACHE=$(ME_HTTP_CACHE)" "-DME_HTTP_CMD=$(ME_HTTP_CMD)" "-DME_HTTP_DEFENSE=$(ME_HTTP_DEFENSE)" "-DME_HTTP_DIGEST=$(ME_HTTP_DIGEST)" "-DME_HTTP_DIR=$(ME_HTTP_DIR)" "-DME_HTTP_HTTP2=$(ME_HTTP_HTTP2)" "-DME_HTTP_PAM=$(ME_HTTP_PAM)" "-DME_HTTP_SENDFILE=$(ME_HTTP_SENDFILE)" "-DME_HTTP_UPLOAD=$(ME_HTTP_UPLOAD)" "-DME_HTTP_WEBSOCKETS=$(ME_HTTP_WEBSOCKETS)" "-DME_MBEDTLS_COMPACT=$(ME_MBEDTLS_COMPACT)" "-DME_MPR_ALLOC=$(ME_MPR_ALLOC)" "-DME_MPR_LOGGING=$(ME_MPR_LOGGING)" "-DME_MPR_OSLOG=$(ME_MPR_OSLOG)" "-DME_MPR_ROMMOUNT=$(ME_MPR_ROMMOUNT)" "-DME_MPR_SSL=$(ME_MPR_SSL)" "-DME_MPR_THREADLIMITBYCORES=$(ME_MPR_THREADLIMITBYCORES)" "-DME_MPR_THREADSTACK=$(ME_MPR_THREADSTACK)" "-DME_OPENSSL_VERSION=$(ME_OPENSSL_VERSION)" "-DME_WATCHDOG_NAME=$(ME_WATCHDOG_NAME)" 
IFLAGS                += "-I$(BUILD)/inc"
LDFLAGS               += "-Wl,-r"
...
ifeq ($(ME_COM_FAST),1)
    TARGETS           += $(BUILD)/bin/fastProgram.out
endif
ifeq ($(ME_COM_HTTP),1)
...
clean:
	...
	rm -f "$(BUILD)/bin/fastProgram.out"
...
$(BUILD)/obj/authpass.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/authpass.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/utils/authpass.c"
...
$(BUILD)/obj/cgiProgram.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cgiProgram.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" $(IFLAGS) $(INPUT) "src/utils/cgiProgram.c"
...
$(BUILD)/obj/convenience.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/convenience.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/convenience.c"
...
$(BUILD)/obj/esp.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/esp.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/esp/esp.c"
...
$(BUILD)/obj/espHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/espHandler.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/espHandler.c"
...
$(BUILD)/obj/espLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/espLib.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/esp/espLib.c"
...
$(BUILD)/obj/fastHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/fastHandler.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/fastHandler.c"
...
$(BUILD)/obj/fastProgram.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/fastProgram.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" $(IFLAGS) "-I/usr/local/include" $(INPUT) "src/utils/fastProgram.c"
...
$(BUILD)/obj/httpLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/httpLib.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/http/httpLib.c"
...
$(BUILD)/obj/makerom.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/makerom.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/makerom/makerom.c"
...
$(BUILD)/obj/mpr-version.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mpr-version.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" $(IFLAGS) $(INPUT) "src/mpr-version/mpr-version.c"
...
$(BUILD)/obj/mprLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mprLib.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/mpr/mprLib.c"
...
$(BUILD)/obj/pcre.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/pcre.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" $(IFLAGS) $(INPUT) "src/pcre/pcre.c"
...
$(BUILD)/obj/proxyHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/proxyHandler.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/proxyHandler.c"
...
$(BUILD)/obj/server.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/server.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/http/server.c"
...
$(BUILD)/obj/sqlite.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/sqlite.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" $(IFLAGS) $(INPUT) "src/sqlite/sqlite.c"
...
$(BUILD)/obj/sqlite3.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/sqlite3.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" $(IFLAGS) $(INPUT) "src/sqlite/sqlite3.c"
...
$(BUILD)/obj/testHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/testHandler.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/testHandler.c"
...
$(BUILD)/obj/testWebSocketsHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/testWebSocketsHandler.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/testWebSocketsHandler.c"
...
$(BUILD)/obj/watchdog.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/watchdog.o" $(CFLAGS) $(DFLAGS) "-DME_DEBUG=1" "-DVXWORKS" "-DRW_MULTI_THREAD" "-DCPU=ARMARCH7" "-DTOOL_FAMILY=gnu" "-DTOOL=gnu" "-D_GNU_TOOL" "-D_WRS_KERNEL_" "-D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\"" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/watchdog/watchdog.c"
...
$(BUILD)/bin/libmpr.out: $(DEPS_67)
	@echo '      [Link] $(BUILD)/bin/libmpr.out'
	$(CC) -r -o "$(BUILD)/bin/libmpr.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/mprLib.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) 
...
$(BUILD)/bin/libpcre.out: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/libpcre.out'
	$(CC) -r -o "$(BUILD)/bin/libpcre.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/pcre.o" $(LIBS) 
endif
...
$(BUILD)/bin/libhttp.out: $(DEPS_69)
	@echo '      [Link] $(BUILD)/bin/libhttp.out'
	$(CC) -r -o "$(BUILD)/bin/libhttp.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/httpLib.o" $(LIBPATHS_69) $(LIBS_69) $(LIBS_69) $(LIBS) 
endif
...
$(BUILD)/bin/libesp.out: $(DEPS_71)
	@echo '      [Link] $(BUILD)/bin/libesp.out'
	$(CC) -r -o "$(BUILD)/bin/libesp.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/espLib.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) "-lmpr-version" 
endif
...
#
ifeq ($(ME_COM_ESP),1)
    DEPS_72 += $(BUILD)/bin/libesp.out
endif
ifeq ($(ME_COM_SQLITE),1)
    DEPS_72 += $(BUILD)/bin/libsql.out
endif
ifeq ($(ME_COM_HTTP),1)
...
$(BUILD)/bin/libappweb.out: $(DEPS_72)
	@echo '      [Link] $(BUILD)/bin/libappweb.out'
	$(CC) -r -o "$(BUILD)/bin/libappweb.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/cgiHandler.o" "$(BUILD)/obj/espHandler.o" "$(BUILD)/obj/fastHandler.o" "$(BUILD)/obj/proxyHandler.o" "$(BUILD)/obj/testHandler.o" "$(BUILD)/obj/testWebSocketsHandler.o" "$(BUILD)/obj/rom.o" $(LIBPATHS_72) $(LIBS_72) $(LIBS_72) $(LIBS) "-lmpr-version" 
...
$(BUILD)/bin/appweb.out: $(DEPS_73)
	...
	$(CC) -o "$(BUILD)/bin/appweb.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/appweb.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) "-lmpr-version" $(LDFLAGS) 
...
$(BUILD)/bin/authpass.out: $(DEPS_74)
	...
	$(CC) -o "$(BUILD)/bin/authpass.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/authpass.o" $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) "-lmpr-version" $(LDFLAGS) 
...
$(BUILD)/bin/cgiProgram.out: $(DEPS_75)
	...
	$(CC) -o "$(BUILD)/bin/cgiProgram.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/cgiProgram.o" $(LIBS) $(LDFLAGS) 
endif
...
#   espcmd
#
DEPS_76 += $(BUILD)/bin/libesp.out
ifeq ($(ME_COM_SQLITE),1)
    DEPS_76 += $(BUILD)/bin/libsql.out
endif
...
$(BUILD)/bin/appweb-esp.out: $(DEPS_76)
	@echo '      [Link] $(BUILD)/bin/appweb-esp.out'
	$(CC) -o "$(BUILD)/bin/appweb-esp.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/esp.o" $(LIBPATHS_76) $(LIBS_76) $(LIBS_76) $(LIBS) "-lmpr-version" $(LDFLAGS) 
endif
...
$(BUILD)/bin/fastProgram.out: $(DEPS_78)
	@echo '      [Link] $(BUILD)/bin/fastProgram.out'
	$(CC) -o "$(BUILD)/bin/fastProgram.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/fastProgram.o" $(LIBS) "-lfcgi" $(LDFLAGS) 
endif
...
$(BUILD)/bin/http.out: $(DEPS_79)
	@echo '      [Link] $(BUILD)/bin/http.out'
	$(CC) -o "$(BUILD)/bin/http.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/http.o" $(LIBPATHS_79) $(LIBS_79) $(LIBS_79) $(LIBS) $(LDFLAGS) 
endif
...
$(BUILD)/bin/libsql.out: $(DEPS_82)
	...
	$(CC) -r -o "$(BUILD)/bin/libsql.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/sqlite3.o" $(LIBS) 
endif
...
$(BUILD)/bin/makerom.out: $(DEPS_83)
	...
	$(CC) -o "$(BUILD)/bin/makerom.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/makerom.o" $(LIBPATHS_83) $(LIBS_83) $(LIBS_83) $(LIBS) $(LDFLAGS) 
...
$(BUILD)/bin/server.out: $(DEPS_84)
	@echo '      [Link] $(BUILD)/bin/server.out'
	$(CC) -o "$(BUILD)/bin/server.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/server.o" $(LIBPATHS_84) $(LIBS_84) $(LIBS_84) $(LIBS) $(LDFLAGS) 
...
$(BUILD)/bin/appman.out: $(DEPS_86)
	...
	$(CC) -o "$(BUILD)/bin/appman.out" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/watchdog.o" $(LIBPATHS_86) $(LIBS_86) $(LIBS_86) $(LIBS) $(LDFLAGS) 
endif
