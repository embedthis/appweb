...
NAME                  := appweb
VERSION               := 9.1.0
PROJECT               := appweb-freebsd-default
PROFILE               ?= dev
...
ME_CONFIGURE          ?= \"me -d -q -platform freebsd-arm-default -configure . --with esp --with mdb --with cgi --with fast --with proxy -gen make\"
ME_CONFIGURED         ?= 1
ME_DEBUG              ?= 1
...
CFLAGS                += -Wall -g -fPIC -fomit-frame-pointer
...
$(BUILD)/obj/appweb.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/appweb.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/server/appweb.c"
...
$(BUILD)/obj/authpass.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/authpass.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/utils/authpass.c"
...
$(BUILD)/obj/cgiHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cgiHandler.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/cgiHandler.c"
...
$(BUILD)/obj/convenience.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/convenience.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/convenience.c"
...
$(BUILD)/obj/esp.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/esp.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/esp/esp.c"
...
$(BUILD)/obj/espHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/espHandler.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/espHandler.c"
...
$(BUILD)/obj/espLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/espLib.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/esp/espLib.c"
...
$(BUILD)/obj/fastHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/fastHandler.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/fastHandler.c"
...
$(BUILD)/obj/http.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/http.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/http/http.c"
...
$(BUILD)/obj/httpLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/httpLib.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/http/httpLib.c"
...
$(BUILD)/obj/makerom.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/makerom.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/makerom/makerom.c"
...
$(BUILD)/obj/mprLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mprLib.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/mpr/mprLib.c"
...
$(BUILD)/obj/proxyHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/proxyHandler.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/proxyHandler.c"
...
$(BUILD)/obj/rom.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/rom.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/rom.c"
...
$(BUILD)/obj/server.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/server.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/http/server.c"
...
$(BUILD)/obj/sqlite3.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/sqlite3.o" $(CFLAGS) "-g" "-fPIC" "-fomit-frame-pointer" "-w" $(DFLAGS) $(IFLAGS) $(INPUT) "src/sqlite/sqlite3.c"
...
$(BUILD)/obj/testHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/testHandler.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/testHandler.c"
...
$(BUILD)/obj/testWebSocketsHandler.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/testWebSocketsHandler.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/modules/testWebSocketsHandler.c"
...
$(BUILD)/obj/watchdog.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/watchdog.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/watchdog/watchdog.c"
